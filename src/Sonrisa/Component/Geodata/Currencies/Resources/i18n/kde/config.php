    ...
    (
		...
		(
			'name'	=>	"Dirham Ya Falme Za Chiarabu",
 			'one'	=>	"Dirham Ya Falme Za Chiarabu",
 			'many'	=>	"Dirham Ya Falme Za Chiarabu"
 		),
		...
		(
			'name'	=>	"Sarafu Ya Chijapani",
 			'one'	=>	"Sarafu Ya Chijapani",
 			'many'	=>	"Sarafu Ya Chijapani"
 		),
		...
		(
			'name'	=>	"Faranga Ya Bukini",
 			'one'	=>	"Faranga Ya Bukini",
 			'many'	=>	"Faranga Ya Bukini"
 		),
